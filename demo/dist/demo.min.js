...
var Tree = function () {
    function Tree(_ref) {
        ...
        this.options = {
            theme: 'default',
            data: {},
            clickCallBack: function clickCallBack(text, v) {
                console.log(text);
            }
        };
        this.level = 0;
    ...
    createClass(Tree, [{
        ...
        value: function initLevel(data) {
            ...
            //初始化数据层级  TODO: 优化--- initLevel 和 createElements合并；
        ...
        value: function createElements() {
            ...
            var menuContainerClass = opened ? 'menu-container show' : 'menu-container hide';
...
var tree = new Tree({ el: document.querySelector('.tree-menu'), options: { data: data } });
